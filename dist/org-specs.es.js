...
import React__default, { createContext, useState, useMemo, useRef, useContext, useEffect, useLayoutEffect } from "react";
...
function isNotGrey(color2) {
  var match = (color2 || "").match(/rgba?\((\d*), (\d*), (\d*)(, [\d.]*)?\)/);
...
const theme = __spreadValues({}, color);
const DefaultButton = styled(Button$1)`
...
export { DefaultButton, PrimaryButton, _eslintrc as eslintConfig, jest_config as jestConfig, _prettierrc as prettierConfig, theme };
//# sourceMappingURL=org-specs.es.js.map
